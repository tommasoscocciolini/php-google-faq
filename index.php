...
<main>
  ...
  <div class="container">
    ...
    "Perché il mio account è associato a un paese?" => "<p>Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose:</p>
    ...
    foreach ($FAQS as $question => $answs) {  ?>
      <h2><?= $question ?></h2>
        <?= $answs ?>
    <?php   }
 ?>
